...
\usepackage[most]{tcolorbox} % used to render the references block
% bibtex does not like rendering inside of tikz drawings... so found a 
% ~equivalent way to do the boxing
